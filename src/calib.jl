...
function fitSpectralLawAndProfile(
    ...
    Threads.@threads for i in findall(valid_lenslets)
        try
            ...
            (fit_lasers_cxs, fit_lasers_cys, fit_fwhms, fit_amplitudes) = fit_lens_lasers(
                bbox, lens_lasers_data, lens_lasers_weights
                ; nλ, lasers_λs, λref, lasers_order,
            ...
            (fit_lamp_cfwhms, fit_lamp_cxs, fit_lamp_back, fit_lamp_amplitudes) = fit_lens_lamp(
                bbox, lens_lamp_data, lens_lamp_weights, lens_lasers_pixels_λs
