...
writefits!("mean-wavelamp.fits", FitsHeader(),                       wavelamps_data,
                                 FitsHeader("EXTNAME" => "weights"), wavelamps_weights)

writefits!("mean-specpos.fits", FitsHeader(),                       specpos_data,
                                FitsHeader("EXTNAME" => "weights"), specpos_weights)
